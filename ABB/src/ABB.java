...
import java.util.function.Function;
        ...
        public class ABB<K, V> implements IMapeamento<K, V> {
            ...
            public String caminhamentoDecrescente(){
                if(vazia()) throw new IllegalStateException("Árvore está vazia");
                else return caminhamentoDecrescente(raiz);
            }
            ...
            public V obterMenor(){
                if(vazia()) throw new IllegalStateException("Arvore está vazia");
            ...
            public Double calcularValorMedio(Function<V, Double> extrator){
                if(vazia()) throw new IllegalStateException("Árvore vazia");
            ...
            private SomaContador calcularValorMedio(Function<V, Double> extrator, No<K, V> raizArvore){
                if(raizArvore == null) return new SomaContador(0.00, 0);
                ...
                return new SomaContador((somaEsquerda.soma + valor + somaDireita.soma), (somaEsquerda.contador + 1 + somaDireita.contador));
            }
